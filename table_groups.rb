...
imaginary_friend =  ["Marcellus", "Klossy", "Ms. Panda", "Arnold Palmer", "Staci", "Pengu", "Mary of Teck, Queen consort of the United Kingdom and the British Dominions and Empress of India", "Sir Frances Drake", "Drake", "Rhi Rhi", "Dora The Expolore As Seen On TV", "Backpack from Dora The Explorer", "Map from Dora the explorer", "Megan Markle", ] 
